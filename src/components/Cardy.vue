<template>
  ...
  >
    ...
    >
      <img class="img" :src="makeSource(item)" />
      <!-- <img
    ...
    <div class="p-6">
      ...
      <p class="block font-medium text-base antialiased leading-relaxed text-gray-700">
        <!-- Enter a freshly updated and thoughtfully furnished peaceful home
        surrounded by ancient trees, stone walls, and open meadows.-->
        {{item.prompt}}
      </p>
      <p class="block text-base mt-3">Seed: {{item.seed}}</p>
      <div class="hidden inline-flex flex-wrap items-center gap-3 mt-8 group">
        <span
    ...
    <div class="p-6 pt-3">
      <button
        @click="removeItem"
        class="thebutton block w-full select-none rounded-lg bg-orange-900 py-3.5 px-7 text-center align-middle font-sans text-sm font-bold uppercase text-white shadow-md shadow-gray-900/10 transition-all hover:shadow-lg hover:shadow-gray-900/20 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
        type="button"
      >Remove</button>
    </div>
  </div>
